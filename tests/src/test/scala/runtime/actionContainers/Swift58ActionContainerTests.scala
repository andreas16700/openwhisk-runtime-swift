...
class Swift58ActionContainerTests extends SwiftActionContainerTests {
  override lazy val swiftContainerImageName = "action-swift-v5.8"
  override lazy val swiftBinaryName = "tests/dat/build/swift5.8/HelloSwift5.zip"
  lazy val partyCompile = "tests/dat/build/swift5.8/SwiftyRequest5.zip"
  lazy val partyCompileCodable = "tests/dat/build/swift5.8/SwiftyRequestCodable5.zip"
